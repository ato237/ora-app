  ...
  return (
    <View style={{backgroundColor:'white',flex:1}}>
        ...
        <View style={{padding:25, alignItems:'center',marginTop:30}}>
            <TouchableOpacity style={{backgroundColor:'#3D5BD7',justifyContent:'center',padding:20, paddingHorizontal:115,borderRadius:10}}>
            <Text style={{color:'white', alignItems:'center', fontSize:16, fontWeight:'bold'}}>Buy Crypto</Text>
            </TouchableOpacity>
